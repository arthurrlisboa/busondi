...
class TestGetRoute(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.get_route = GetRoute(routes_repo, route_stop_repo)

    def test_get_routes_from_stop(self):
        routes_list = self.get_route.get_routes_from_stop('104787000120')
    ...
    def test_get_all_routes(self):
        routes_list = self.get_route.get_all_routes()
    ...
    def test_get_route_by_id(self):
        route = self.get_route.get_route_by_id('609-03')
