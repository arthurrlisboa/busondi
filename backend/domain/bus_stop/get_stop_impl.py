...
class GetStopImpl:
    ...
    def get_all_stops_impl(self):
        ...
        stops_list = [BusStop(stop.stop_id, stop.stop_name, stop.stop_lat, stop.stop_lon) for stop in all_stops]
        return stops_list
    ...
    def get_stops_coordinates_impl(self, stops_list):
        ...
        coordinate_list = [(stop.stop_lon, stop.stop_lat) for stop in stops_in_list]
    ...
    def get_stops_from_route_impl(self, route_id):
        ...
        stops_list = [BusStop(stop.stop_id, stop.stop_name, stop.stop_lat, stop.stop_lon) for stop in stops]
        return stops_list